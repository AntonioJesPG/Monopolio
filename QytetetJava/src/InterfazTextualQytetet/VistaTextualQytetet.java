...
public int menuSalirCarcel(){
   ...
   mostrar("Elige el método para salir de la carcelr");
   Map<Integer, String> menuSC = new TreeMap();
   menuSC.put(0, "Tirar Dado");
   menuSC.put(1, "Pagar por libertad");
  ...
  public boolean elegirQuieroComprar(){
   ...
   menuQC.put(0, "Comprar");
   menuQC.put(1, "No Comprar");
   int salida=this.seleccionMenu(menuQC);
   return salida==0; // se pide si o no se quiere comprar una propiedad. Por completar
 }
